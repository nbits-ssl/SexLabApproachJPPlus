...
まれに確認されているバグらしきもので最近Fixしたもの
・死体となった敵にアプローチ、蘇生させてことに及ぶことがある(09/05 Fix)。
...
・死体となったNPCからのアプローチ、死体へのアプローチバグをFix。(Thanx! bbspinkスレ85の409)
・自キャラへのレイプ判定に「獣の心」が反映されていないバグをFix。
