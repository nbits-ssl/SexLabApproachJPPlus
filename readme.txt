...
・PCへの声掛け時「誰かを誘おう」選択肢で3Pまでできるように
...
・PC声掛けのダイアログの種別が変わる性欲値の値をMCMから変更できるように
・NPC間のキス・ハグ時、今まで無言だったのを、声掛け側が一声発するように変更
...
　※ キスの備考（モーションはkissingタグがあり、sexタグがないものを使用・"Letio Kissing"）
